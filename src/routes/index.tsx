...
export default component$(() => {
  return (
    <main class="flex min-h-screen flex-col p-6">
      <div class="flex h-20 shrink-0 items-end rounded-lg  bg-gradient-to-br from-pastel to-skin  p-4 md:h-52">
        {/* <LRDQwikLogo /> */}
      </div>
      <div class="flex h-20 shrink-0 items-end rounded-lg  bg-gradient-to-br from-blue-800 to-[#D8ECFF]  p-4 md:h-52">
      </div>
