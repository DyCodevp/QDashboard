  ...
  return (
    <div class="flex h-full flex-col px-3 py-4 md:px-2">
      <Link
        ...
        href="/"
      >
        <div class="w-32 text-white text-4xl md:w-[11rem]">
          Qdash
        </div>
      </Link>
      <div class="flex grow flex-row justify-between space-x-2 md:flex-col md:space-y-2 md:space-x-0">
        ...
        <form preventdefault:submit>
          <button onClick$={() => nav("/")} class="flex h-[48px] w-full grow items-center justify-center gap-2 rounded-md bg-gray-50 p-3 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3">
